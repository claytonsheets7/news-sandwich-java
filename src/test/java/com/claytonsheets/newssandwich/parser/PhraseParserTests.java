...
public class PhraseParserTests {
	...
	public void parsePhraseTest() {
		...
		final Set<String> expected = new HashSet<>(Arrays.asList("this", "is", "a", "phrase", "I", "want", "a", "clean", "list", "of", "words", "despite", "having", "o", "many", "strnge", "characters"));
		...
		for(final String actualWord : actual) {
			softAssert.assertTrue(expected.contains(actualWord), "Set should have contained the word " 
		+ actualWord);
		}
